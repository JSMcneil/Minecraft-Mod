...
public class ModelClydesdaleSH extends ModelHorseSH
{
  public ModelClydesdaleSH()
  {
    textureWidth = 128;
    textureHeight = 64;
	...
	setTextureOffset("legReRi.leg", 26, 21);
	setTextureOffset("legReLe.leg", 26, 21);
	...
	setTextureOffset("neckbottom.main", 0, 38);
	  ...
	  tail.addBox("main", -2F, -6F, 0F, 4, 6, 6);
	  body.addChild(tail);
      
      legReRi = new ModelRendererSH(this, "legReRi");
	  legReRi.setRotationPoint(-3F, 7F, 18F);
      legReRi.addBox("leg", -3F, 0F, -2F, 4, 17, 4);
      
      legReLe = new ModelRendererSH(this, "legReLe");
      legReLe.setRotationPoint(3F, 7F, 18F);
	  legReLe.addBox("leg", -1F, 0F, -2F, 4, 17, 4);
      
      legFrRi = new ModelRendererSH(this, "legFrRi");
      legFrRi.setRotationPoint(-3F, 7F, -1.8F);
      legFrRi.addBox("leg", -3F, 0F, -3F, 4, 17, 4);
      
      legFrLe = new ModelRendererSH(this, "legFrLe");
      legFrLe.setRotationPoint(3F, 7F, -1.8F);
      legFrLe.addBox("leg", -1F, 0F, -3F, 4, 17, 4);
	  ...
	  head.addBox("muzzle", -3F, -2F, -10F, 6, 7, 3);
