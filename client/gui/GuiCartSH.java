...
public class GuiCartSH extends GuiContainer {

	public GuiCartSH(InventoryPlayer inventoryplayer, IInventoryEntitySH entitycart)
    {
        super(new ContainerSH(inventoryplayer, entitycart));
